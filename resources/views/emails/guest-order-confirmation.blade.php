{{-- resources/views/emails/guest-order-confirmation.blade.php --}}
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="text-align: right; margin: 20px 0;">
                ...
                @endif
                <p style="font-size: 18px; font-weight: bold; color: #2563eb;"><strong>Total:</strong> ৳{{ number_format($total, 2) }}</p>
            </div>
            
                   
            <div style="margin: 20px 0;">
                <a href="{{ $signedDownloadUrl }}" class="text-light">
                    Download Invoice
                 </a>
            </div>
