            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Attributes</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Image</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Price Adj.</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($variants as $variant)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-right {{ $variant->price_adjustment >= 0 ? 'text-green-600' : 'text-red-600' }}">
                                {{ $variant->price_adjustment >= 0 ? '+' : '' }}{{ number_format($variant->price_adjustment, 2) }}
                            </td>
                            <td class="px-6 py-4 text-sm text-right font-medium">
                                ৳{{ ($variant->product->sale_price ?? $variant->product->base_price) + $variant->price_adjustment }}
                            </td>
