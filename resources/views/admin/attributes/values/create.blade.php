...
@section('title', 'Create Value - ' . $attribute->name)

@section('content')
<div class="">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-500">Create New Value</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('admin.attributes.values.store', $attribute) }}" 
              method="POST" 
              class="p-6">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-blue-50 p-4 rounded-lg">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <h4 class="text-sm font-medium text-blue-800">Size Format</h4>
                                <p class="text-xs text-blue-700 mt-1">
                                    Use standard size formats like XS, S, M, L, XL, XXL, or numeric sizes like 38, 40, 42.
                                </p>
                            </div>
                        </div>
                    </div>
